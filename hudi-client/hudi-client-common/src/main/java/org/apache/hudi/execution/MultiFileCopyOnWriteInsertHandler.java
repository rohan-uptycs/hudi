 ...
 */
public class MultiFileCopyOnWriteInsertHandler<T>
  ...
  private final BulkInsertPartitioner bulkInsertPartitioner;
  ...
  private final Map<Integer, HoodieWriteHandle> handles = new HashMap<>();

  public MultiFileCopyOnWriteInsertHandler(HoodieWriteConfig config, String instantTime,
                                           boolean areRecordsSorted, HoodieTable hoodieTable,
  ...
  public void consume(HoodieInsertValueGenResult<HoodieRecord> genResult) {
    ...
    Integer index = bulkInsertPartitioner.getKeyToFileMapping(record.getKey());
    String idPrefix = bulkInsertPartitioner.getFileIdPfx(index);
    HoodieWriteHandle<?, ?, ?, ?> handle = handles.get(index);
    if (handle == null) {
      ...
      Option<WriteHandleFactory> writeHandleFactoryOption = bulkInsertPartitioner.getWriteHandleFactory(index);
      WriteHandleFactory writeHandleFactory = writeHandleFactoryOption.get();
